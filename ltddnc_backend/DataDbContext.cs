    ...
    public class DataDbContext : DbContext
    {
        ...
        public void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(
                new Category() { Id = 1, Name = "Burger", State = 1 },
                new Category() { Id = 2, Name = "Gà Rán", State = 1 },
                new Category() { Id = 3, Name = "Mì Ý", State = 1 },
                new Category() { Id = 4, Name = "Thức Uống", State = 1 },
                new Category() { Id = 5, Name = "Kem", State = 0 });

            modelBuilder.Entity<Product>().HasData(
              new Product() { Id = 1, Name = "Gà sốt đậu", Description = "Gà sốt với đậu", Stock = 100, State = 1, IdCategory = 1, UnitPrice = 38000 },
              new Product() { Id = 2, Name = "Gà sốt H&S", Description = "Gà sốt H&S", Stock = 100, State = 1, IdCategory = 1, UnitPrice = 38000 },
              new Product() { Id = 3, Name = "Burger Mozzarella", Description = "Burger Mozzarella", Stock = 100, State = 1, IdCategory = 2, UnitPrice = 50000 },
              new Product() { Id = 4, Name = "Burger Double Double", Description = "Burger Double Double", Stock = 100, State = 1, IdCategory = 2, UnitPrice = 60000 },
              new Product() { Id = 5, Name = "Mì Ý", Description = "Mì Ý", Stock = 100, State = 1, IdCategory = 3, UnitPrice = 35000 },
              new Product() { Id = 6, Name = "Mì Ý Thịt Bò", Description = "Mì Ý Thịt Bò", Stock = 100, State = 1, IdCategory = 3, UnitPrice = 40000 },
              new Product() { Id = 7, Name = "7Up Dưa Lưới Đào", Description = "7Up Dưa Lưới Đào", Stock = 100, State = 1, IdCategory = 4, UnitPrice = 15000 },
              new Product() { Id = 8, Name = "Nước Cam", Description = "Nước Cam", Stock = 100, State = 1, IdCategory = 4, UnitPrice = 18000 },
